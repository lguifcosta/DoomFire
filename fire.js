...
function calculateFirePropagation() {
    for (let column =0; column< fireWidth;column++){
        for (let row= 0;row< fireHeigth;row++){
            ...
            updateFireIntensityPerPiex(pixelIndex)
        }
    }

renderFire()
 }
 function updateFireIntensityPerPiex(currentPixelIndex){
...
window.document.querySelector('div#fireCanvas').innerHTML = html
}
